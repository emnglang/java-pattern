...
// ISubject.java Copyright (c) 2009 Giovanni Azua Garcia
...
/**
 * <b>Observer Design Pattern</b>: Define a one-to-many dependency between
 * objects so that when one object changes state, all its dependents are
 * notified and updated automatically. (Gamma et al, Design Patterns)<br/>
 * <br/>
 * 
...
interface ISubject<E> 
{
     ...
     * <code>ISubject</code> instance.
     * 
     * @param anObservers <code>IObserver</code> instances to be detached.
     * @throws IllegalArgumentException 'anObservers' must not be null. 
     */
    public void 
    ...
    //-------------------------------------------------------------------------
    /**
     * Returns the number of attached <code>IObserver</code> instances
     * 
     * @return Number of attached <code>IObserver</code> instances.
     */
    public int 
    size();
}
